...
public class Navbar extends BasePage {
    ...
    private static final String NAV_LINK       = ".nav-link[href=\"%s\"]";
    private static final String PRODUCTS_LINK  = NAV_LINK.formatted(HashRoute.PRODUCTS);
    private static final String BOOKINGS_LINK  = NAV_LINK.formatted(HashRoute.BOOKINGS);
    private static final String USERS_LINK     = NAV_LINK.formatted(HashRoute.USERS);
